...
const GeminiStreamingChatModelNodeConfigureForm = ({ nodeParameters, onChange }) => {
  ...
  return (
    <div>
      <div class="alert alert-info">{t('gemini-streaming-chat-model-node-description')}</div>
...
export default GeminiStreamingChatModelNodeConfigureForm;
