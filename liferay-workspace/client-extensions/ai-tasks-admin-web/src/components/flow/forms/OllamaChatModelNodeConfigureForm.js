      ...
      <Tab id={'generalSettings'} label={'General Settings'}>
        <div>
          <div className="form-group">
            ...
            />
            <small className="form-text text-muted">The base url of the Ollama server.</small>
          </div>
          <div className="form-group">
        ...
        <div>
          ...
          <div className="form-group">
            ...
            <input
              ...
              id="repeatPenalty"
              min="1"
              value={nodeParameters.repeatPenalty}
              onChange={(e) => {
                onChange('repeatPenalty', e.currentTarget.value);
              }}
            />
            <small className="form-text text-muted">
              See https://docs.langchain4j.dev/integrations/language-models/ollama/
            </small>
          </div>
          ...
          <div className="form-row">
            <div className="form-group col-6">
              <label htmlFor="numCtx">Number CTX</label>
              <input
                type="number"
                className="form-control"
                id="numCtx"
                value={nodeParameters.numCtx}
                onChange={(e) => {
                  onChange('numCtx', e.currentTarget.value);
                }}
              />
              <small className="form-text text-muted">
                See https://docs.langchain4j.dev/integrations/language-models/ollama/
            ...
            <div className="form-group col-6">
              <label htmlFor="numPredict">Number Predictions</label>
              <input
                type="number"
                className="form-control"
                id="numPredict"
                min="1"
                value={nodeParameters.numPredict}
                onChange={(e) => {
                  onChange('numPredict', e.currentTarget.value);
                }}
              />
              <small className="form-text text-muted">
                See https://docs.langchain4j.dev/integrations/language-models/ollama/
...
export default OllamaChatModelNodeConfigureForm;
