...
const MistralAIChatModelNodeConfigureForm = ({ nodeParameters, onChange }) => {
  ...
  return (
    <div>
      <div class="alert alert-info">{t('mistralai-chat-model-node-description')}</div>
      ...
      <TabContent activeTab={activeTab}>
        ...
        <div id="promptSettings">
          <div>
            ...
            <BooleanField
              onChange={onChange}
              parameterName="safePrompt"
              parameterValue={nodeParameters.safePrompt}
            />
          </div>
        </div>
...
export default MistralAIChatModelNodeConfigureForm;
