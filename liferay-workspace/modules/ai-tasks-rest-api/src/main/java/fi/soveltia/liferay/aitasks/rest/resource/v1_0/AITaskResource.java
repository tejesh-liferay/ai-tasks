package fi.soveltia.liferay.aitasks.rest.resource.v1_0;
 ...
 *
 *     curl -u your@email.com:yourpassword -D - http://localhost:8080/o/ai-tasks/v1.0
 *
...
@Generated("")
@ProviderType
public interface AITaskResource {
	...
	public Response postAITaskBatch(
			AITask aiTask, String callbackURL, Object object)
		throws Exception;
	...
	public Response deleteAITaskBatch(
			Long aiTaskId, String callbackURL, Object object)
		throws Exception;

	public AITask getAITask(Long aiTaskId) throws Exception;

	public AITask patchAITask(Long aiTaskId, AITask aiTask) throws Exception;

	public AITask putAITask(Long aiTaskId, AITask aiTask) throws Exception;

	public Response putAITaskBatch(
			Long aiTaskId, AITask aiTask, String callbackURL, Object object)
		throws Exception;
