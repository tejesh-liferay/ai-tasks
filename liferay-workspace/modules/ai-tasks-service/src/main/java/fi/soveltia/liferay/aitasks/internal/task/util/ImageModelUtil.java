...
public class ImageModelUtil {
    ...
    public static String generateImage(JSONObject jsonObject, String text, String type) {

        if (type == null) {
            throw new IllegalArgumentException("Image model type is not defined");
        }

        if (StringUtil.equals(type, "googleImagen")) {
            return ImageModelUtil.generateVertexAIImageModelImage(jsonObject, text);
        } else if (StringUtil.equals(type, "openAIImageModel")) {
            return ImageModelUtil.generateOpenAIImageModelImage(jsonObject, text);
        }

        throw new IllegalArgumentException("Unknown image model");
    }

    public static String generateOpenAIImageModelImage(JSONObject jsonObject, String text) {
        return _generateImage(getOpenAIImageModel(jsonObject), text);
    }

    public static String generateVertexAIImageModelImage(JSONObject jsonObject, String text) {
    ...
    public static VertexAiImageModel getVertexAiImageModel(JSONObject jsonObject) {
        ...
        VertexAiImageModel.ImageStyle imageStyle = _getVertexAiImageStyle(jsonObject);
